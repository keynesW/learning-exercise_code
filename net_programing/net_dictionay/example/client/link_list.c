...
void list_Insert_head(link_list_t * ptr_list_head ,data_t data)
{
...
void list_Insert_order(link_list_t * ptr_list_head,data_t data)
{
...
void del_node(link_list_t * ptr_list_head,data_t data)
{
