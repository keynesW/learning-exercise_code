...
extern void list_Insert_head(link_list_t * ptr_list_head ,int data);
extern void list_Insert_end(link_list_t * ptr_list_head ,int data);
extern void print_linklist( link_list_t * ptr_list_head);
extern void free_list(link_list_t * ptr_list_head);
extern void list_Insert_order(link_list_t * ptr_list_head,int data);
extern void del_node(link_list_t * ptr_list_head,int data);
